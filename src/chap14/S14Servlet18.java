...
public class S14Servlet18 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String sql = "SELECT CustomerID, CustomerName, PostalCode, City, Country "
				+ "FROM Customers "
				+ "ORDER BY CustomerID ";
		...
		try (Connection con = ds.getConnection();
			...
			while (rs.next()) {
				...
				cus.setPostCode(rs.getString(3));
		...
		String path = "/WEB-INF/view/chap14/ex12.jsp"; // 손님 목록이 table로 출력
