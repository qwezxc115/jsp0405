...
SELECT * FROM Products JOIN Categories ON Products.CategoryID = Categories.CategoryID; -- Cartesian Product
...
SELECT p.ProductName, p,Unit, p,Price, s.SupplierName
FROM Products p
JOIN Suppliers s
...
SELECT * FROM Customers c JOIN Suppliers s ON c.Country = s.Country ORDER BY 1;
